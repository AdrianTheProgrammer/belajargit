...
func (_m *TServices) CreateTodo(_a0 todos.Todos) error {
	ret := _m.Called(_a0)
...
func (_m *TServices) DeleteTodo(_a0 uint) error {
	ret := _m.Called(_a0)
...
func (_m *TServices) ReadAllTodos(_a0 uint) ([]todos.Todos, error) {
	ret := _m.Called(_a0)
...
func (_m *TServices) UpdateTodo(_a0 uint, _a1 todos.Todos) error {
